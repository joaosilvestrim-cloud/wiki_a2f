        ...
        >
          <div className="bg-blue-950/50 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-blue-800/50">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-white mb-2">Intranet A2F</h1>
              <p className="text-blue-200">Acesse sua conta corporativa</p>
            </div>
            ...
            >
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-blue-900/30 border border-blue-800/50 rounded-lg text-white placeholder-blue-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 bg-blue-900/30 border border-blue-800/50 rounded-lg text-white placeholder-blue-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                    placeholder="••••••••"
                    required
                    disabled={isLoggingIn || !isConfigured}
                  />
              ...
              <Button
                type="submit"
                disabled={isLoggingIn || !isConfigured}
                className="w-full bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-primary-foreground font-semibold py-3 rounded-lg transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {isLoggingIn ? (
